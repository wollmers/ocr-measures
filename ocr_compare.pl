...
sub print_stats {
  ...
  my $lines = [
    {'items_ocr'     => {'label'=> 'items ocr:  ', 'mask' => '%6s',   'comment' => 'matches + inserts + substitutions'}},
    {'items_grt'     => {'label'=> 'items grt:  ', 'mask' => '%6s',   'comment' => 'matches + deletions + substitutions'}},
    {'matches'       => {'label'=> 'matches:    ', 'mask' => '%6s',   'comment' => 'matches'}},
    {'edits'         => {'label'=> 'edits:      ', 'mask' => '%6s',   'comment' => 'inserts + deletions + substitutions'}},
    {'substitutions' => {'label'=> ' subss:     ', 'mask' => '%6s',   'comment' => 'substitutions'}},
    {'inserts'       => {'label'=> ' inserts:   ', 'mask' => '%6s',   'comment' => 'inserts'}},
    {'deletions'     => {'label'=> ' deletions: ', 'mask' => '%6s',   'comment' => 'deletions'}},
